...
public class GenericArrayAdapter<T extends IFields> extends ArrayAdapter<T> {
    private Context mContext;
    private List<T> mValues;

    public GenericArrayAdapter(Context context, int textViewResourceId, List<T> objects)
    {
